...
float3 CalculateCelShading(Light l, SurfaceVariables s,float3 rimColor)
{
    float attenuation =
...
void LightingCelShaded_float(float Smoothness,
      ...
      float EdgeShadowAttenuation, float EdgeRim,float3 RimColor, out float3 Color)
{
   ...
   float4 shadowCoord = ComputeScreenPos(clipPos);
    ...
    Color = CalculateCelShading(light, s,RimColor);
